...
})({"kfqLO":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "5bfca0f5bf3a855d";
"use strict";
...
},{}],"hngJt":[function(require,module,exports) {
...
async function validarLogin(e) {
    ...
    try {
        ...
        let usuarios = await (0, _services.getUsers)(); // getUsers() debería devolver una lista de usuarios
        ...
        alert("No se encontr\xf3 un usuario con ese correo electr\xf3nico");
    } catch (error) {
        console.error("Error al procesar la solicitud:", error);
        alert("Ocurri\xf3 un error al procesar tu solicitud. Int\xe9ntalo de nuevo m\xe1s tarde.");
    }
}
btnInicio.addEventListener("click", validarLogin);

},{"../services/Services":"jRPE4"}],"jRPE4":[function(require,module,exports) {
...
async function EliminarUsuario(id1) {
    try {
        const response = await fetch(`http://localhost:3001/users/${id1}`, {
            method: "DELETE",
            headers: {
                "Content-Type": "application/json"
            }
        });
        if (!response.ok) throw new Error(`Error deleting user with id ${id1}`);
        return {
            message: `User with id ${id1} deleted successfully`
        };
    } catch (error) {
...
},{}]},["kfqLO","hngJt"], "hngJt", "parcelRequire6682")

//# sourceMappingURL=Login.bf3a855d.js.map
