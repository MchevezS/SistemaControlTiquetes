...
async function validarVacios(e) {
    ...
    try {
        ...
        let usuarios = await (0, _services.getUsers)(); // getUsers() devuelve una lista de usuarios
        //Verifica si ya existe un usuario con el mismo correo
        let usuarioExistente = usuarios.find((user)=>user.email === email);
        if (usuarioExistente) {
            if (usuarioExistente.nombre === nombre) // Usuario ya registrado con el mismo correo y nombre
            alert("Ya existe un usuario con el mismo correo y nombre");
            else // Correo ya registrado pero con un nombre diferente
            alert("El correo electr\xf3nico ya est\xe1 en uso. Por favor, usa un correo diferente.");
        } else {
            await (0, _services.postUsers)(userData);
...
},{}]},["gTVwJ","dRLDE"], "dRLDE", "parcelRequire6682")
